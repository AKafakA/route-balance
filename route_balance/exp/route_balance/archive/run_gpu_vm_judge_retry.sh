...
echo "=========================================="
echo "Judge_class retries (was: OOM from GPU contention)"
echo "=========================================="

echo "[$(date)] 1/2: ModernBERT fused judge_class..."
...
echo "[$(date)] 2/2: ModernBERT 7B judge_class..."

...
# Configuration
TARGET_HOST="asdwb@c240g5-110131.wisc.cloudlab.us"  # Host to run ROUTE_BALANCE server
...
HOSTS_FILE="route_balance/config/p100_smoke/hosts"
DEPLOYMENT_CONFIG="route_balance/config/route_balance/model_deployment_p100_smoketest.json"

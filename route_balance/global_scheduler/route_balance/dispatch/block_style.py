"""Block-style dispatch — predicted-latency minimization (A1.2 / #25).

Signal (per Block paper main.tex §4, socc_po2_ablation.tex §6.8):
...
Block's "simulation-based dispatching" in the RouteBalance deployment.
...
class BlockStyleDispatch(DispatchBase):
    ...
    async def choose_instance(
        ...
        *,
        ...
        if not candidates:
            raise ValueError("BlockStyleDispatch: empty candidate list")
